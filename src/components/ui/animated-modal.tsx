      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "bg-dark relative z-50 flex max-h-[90%] min-h-[50%] flex-1 flex-col overflow-hidden border border-transparent md:max-w-[40%] md:rounded-2xl dark:border-neutral-800 dark:bg-neutral-950",
              className,
            )}
            initial={{
              opacity: 0,
...
const CloseIcon = () => {
  ...
  return (
    <button
      ...
      className="group absolute right-8 top-4 rounded-full bg-white/20 p-1 transition-colors hover:bg-white/40 md:right-4 md:top-4"
    >
      <svg
